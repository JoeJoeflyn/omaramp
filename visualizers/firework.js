// Firework — cliamp vis_firework.go: deterministic bursts, trails, gravity, fade
.pragma library
...
function render(ctx, d) {
  ...
  for (var i = 0; i < numBursts; i++) {
    ...
    if (localFrame < launchLen) {
      // Rising trail from bottom to burst center (cliamp exact)
      ...
      // Burst expansion and fade (cliamp exact)
      ...
      // ponytail: cliamp uses dot units (3-11) on a 160×40 grid; our canvas is
      ...
      // Gravity pulls particles down (cliamp exact: burstT² × 5, scaled by S)
      var gravity = burstT * burstT * 5.0 * S
      // Particles fade out (cliamp exact)
      ...
      for (var p = 0; p < numParticles; p++) {
        ...
        // Stochastic fade (cliamp exact hash args)
